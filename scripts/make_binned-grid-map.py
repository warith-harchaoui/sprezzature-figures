...
This module builds the SVG string by hand, because a square lattice
clipped to an irregular city boundary over a river and two parks is
clearer authored directly.
