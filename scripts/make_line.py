...
This module draws the polylines and points by hand, so every point
carries a native ``<title>`` tooltip, and hovering a series highlights
...
def build_svg(
    ...
    if log_y:
        ...
        # fractions, which produced unreadable labels.
