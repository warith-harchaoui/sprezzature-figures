...
group, few across) and colours every node by its group. The layout is
precomputed in **pure Python**: a Barnes-Hut-free but sfdp-flavoured
Fruchterman-Reingold relaxation with a
