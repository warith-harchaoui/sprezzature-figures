...
This module builds the SVG string by hand, because true polar wedges
(annular sectors keyed to compass bearings) are far clearer authored
directly. It follows the sprezzature-* house style: a
...
DEMO_DATA: List[Dict[str, Any]] = [
    ...
    for direction, row in zip(
        ...
        [
            ...
            [1.0, 1.2, 0.8, 0.3, 0.1, 0.0],  # N
            [0.9, 1.0, 0.5, 0.2, 0.1, 0.0],  # NNE
            [0.8, 0.9, 0.4, 0.2, 0.0, 0.0],  # NE
            [0.7, 0.8, 0.4, 0.1, 0.0, 0.0],  # ENE
            [0.8, 1.0, 0.5, 0.2, 0.1, 0.0],  # E
            [0.9, 1.1, 0.7, 0.3, 0.1, 0.0],  # ESE
            [1.0, 1.3, 0.9, 0.4, 0.2, 0.1],  # SE
            [1.1, 1.5, 1.1, 0.7, 0.3, 0.1],  # SSE
            [1.2, 1.8, 1.4, 0.9, 0.4, 0.2],  # S
            [1.4, 2.3, 2.0, 1.3, 0.8, 0.3],  # SSW
            [1.7, 3.2, 3.0, 2.3, 1.4, 0.8],  # SW
            [2.1, 3.9, 4.2, 3.5, 2.4, 1.5],  # WSW  (prevailing + strongest)
            [1.8, 3.4, 3.5, 2.6, 1.6, 1.0],  # W
