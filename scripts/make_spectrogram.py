...
(y) grid whose cell colour encodes *power* (loudness) in decibels. It is
the canonical way to *see* how the frequency content of a sound evolves
over time.

This module builds the SVG string **by hand**: it synthesises a short,
communicative audio clip with numpy
