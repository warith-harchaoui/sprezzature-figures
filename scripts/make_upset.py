...
This generator builds the SVG string by hand, since the three-panel
matrix geometry with connector lines aligned to bars is clearer authored
directly. It follows the
