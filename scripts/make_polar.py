...
line that falsely "jumps" from the right edge back to the left.

This module builds the SVG string **by hand**: it maps a cyclic series
onto polar coordinates, draws the
