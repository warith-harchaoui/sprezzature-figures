...
``pypi.org/project/sprezzature-figures/EXAMPLES.md``, a 404, and a relative image
...
def test_readme_targets_are_absolute() -> None:
    ...
    assert not relative, (
        ...
        "Point these at https://github.com/warith-harchaoui/sprezzature-figures/blob/main/… "
        "instead:\n  " + "\n  ".join(relative)
    )
