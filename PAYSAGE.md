...
```
suite sprezzature
├── sprezzature-figures   ← ce paquet  (127 types de graphiques)
...
- Vous avez besoin de 127 types de graphiques prêts à l'emploi via une API unique et cohérente.
...
![sprezzature-figures face à 36 autres outils de visualisation de données, positionnés sur deux axes issus d'une ACP](assets/paysage.svg)
