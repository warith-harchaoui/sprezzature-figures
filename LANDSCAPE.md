...
```
sprezzature suite
├── sprezzature-figures   ← this package (127 chart types)
...
- You need 127 ready-to-use chart types behind a single consistent API, where `make_figure("treemap", data)` just works without reading docs.
...
![sprezzature-figures against 36 other data-viz tools, positioned on two PCA-derived axes](assets/landscape.svg)
